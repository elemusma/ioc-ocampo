...
add_action('wp_enqueue_scripts', 'ocampo_stylesheets');
// for footer
function ocampo_stylesheets_footer() {
...
add_action('get_footer', 'ocampo_stylesheets_footer');
...
add_action('after_setup_theme', 'ocampo_menus');
